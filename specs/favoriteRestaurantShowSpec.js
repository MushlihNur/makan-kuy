...
describe('Showing all favorite restaurants', () => {
  ...
  describe('When no restaurant have been liked', () => {
    ...
    it('should show the information that no restaurants have been liked', (done) => {
      document.getElementById('resto').addEventListener('restaurants:updated', () => {
  ...
  describe('When favorite restaurants exist', () => {
    it('should show the restarants', (done) => {
      document.getElementById('resto').addEventListener('restaurants:updated', () => {
      ...
      favoriteRestaurants.getAllRestaurants.and.returnValues([
        {
          id: 11, name: 'A', rating: 3, description: 'Sebuah restorant A',
        },
        {
          id: 22, name: 'B', rating: 4, description: 'Sebuah restorant B',
        },
      ]);
